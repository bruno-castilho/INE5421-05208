...
def determinize(af: AF):
            ...
            while len(states_found) != 0:
                ...
                for symbol in new_symbols:
                    ...
                    if str(state) not in new_states:
            ...
            return AF(states=new_states, initial_state=new_initial_state, symbols=new_symbols, final_states=new_final_states, transitions=new_transitions)

def main():
    af = AF(states=['q0','q1', 'q2', 'q3', 'q4'], 
            initial_state='q0', 
            symbols=['a', 'b', '&'], 
            final_states=['q1', 'q2'],
            transitions= { 
